...
async def main():
    ...
    def create_prompts(model: str, topics: List[str], response_formats: List[Literal["text", "structured_output", "tool"]]):
        prompts = []
    ...
    response_formats : List[Literal["text", "structured_output", "tool"]] = ["text", "structured_output", "tool"]
