...
def analyze_and_plot_auction_results(auction, env, pdf_filename="auction_report.pdf"):
    ...
    num_buyers = sum(1 for agent in env.agents if agent.zi_agent.preference_schedule.is_buyer)
    num_sellers = sum(1 for agent in env.agents if not agent.zi_agent.preference_schedule.is_buyer)
